...
urlpatterns = [
    path('warehouse-list', WarehouseAPIView.as_view()),
    path('product-list', ProductAPIView.as_view()),
    path('customer-list', CustomerAPIView.as_view()),
    path('shipment-list', ShipmentAPIView.as_view()),
    ...
    path('warehouse-retrieve/<str:pk>', ShipmentRetrieveAPIView.as_view()),
    ...
    path('warehouse-rud/<str:pk>', CustomerRUDAPIView.as_view()),
